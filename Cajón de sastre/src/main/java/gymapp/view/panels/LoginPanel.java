...
public class LoginPanel extends JPanel {
	...
	public LoginPanel(List<JPanel> panels) {
		...
		// Hacer que Enter en los campos de texto simule un clic en el botón
		textUserName.addActionListener(e -> btnLogin.doClick());
		textPassword.addActionListener(e -> btnLogin.doClick());
