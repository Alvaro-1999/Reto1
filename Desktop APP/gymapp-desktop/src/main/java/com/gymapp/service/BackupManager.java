...
public class BackupManager {
    ...
    public BackupManager() {
        new File(PATH).mkdirs(); // crear carpeta si no existe
    }

    // 🔹 Cargar todos los backups locales (.dat)
    ...
    private <T> List<T> cargarArchivo(String fileName, Class<T> clazz)
        ...
        System.out.println("⚠️ Archivo " + fileName + " está vacío o no contiene lista válida.");
        return new ArrayList<>();
    }
